...
const BodyInitialScreen = ({ displayChatScreen }) => (
  <section
  ...
  >
    <div className="initial-screen__area">
      {imgSvg()}
      <h1 className="initial-screen__title">Welcome To WhatsApp Web Robot</h1>
      <p className="initial-screen__text">
        WhatsApp connects to your phone to sync message. To reduce data usage,
        connect your phone to Wi-Fi.
      </p>
      <hr />
      <MdOutlineComputer className="initial-screen__icon" />
      <span className="initial-screen__span">
        WhatsApp is available for Windows.
        <a href="/" className="initial-screen__windows-link">
          Get it here.
        </a>
      </span>
    </div>
